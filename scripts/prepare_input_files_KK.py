...
wells = ['B5']
base_input_tiff_dir = '20230210_SBS_data/SBS_images/plate_10_tiffs_rotated/'
tiles = [20]
#tiles = np.arange(0,124)
######################
...
for well in wells:
    for tile in tiles:
        for cycle in cycles:
            input_file_search = base_input_tiff_dir + f'/well_{well}/cycle_{cycle}/Well{well}*tile{tile}.tif'
